...
function mixed_integer_linear_programming(cobj::Vector, A::Matrix, b::Vector, lb::Vector, ub::Vector, vtype::Vector)
    # initialize model
    env_p = Ref{Ptr{Cvoid}}()
...
x = mixed_integer_linear_programming(cobj, A, b, lb, ub, vtype)